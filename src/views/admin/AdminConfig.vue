      ...
      <div class="mt-3 space-y-4">
        ...
        <div>
          ...
          <ImageUpload
            ...
            :error="errorBanner"
            ratio="aspect-[4/1]"
            recomendado="1920 × 480 px (proporción 4:1)"
            nota="Con esa proporción se ve completa en la compu. En celular se recorta un poco a los lados — dejá lo importante al centro."
